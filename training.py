...
def run_training(game, agent1, agent2, n_episodes, batch_size, roles="switch", show_plot=True):
    fig = plt.figure()
    ...
    for i in range(N_EPISODES):
        game.reset()
        sender_state = game.get_sender_state(n_images=N_CHOICES, unique_categories=True)
